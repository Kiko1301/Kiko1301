...
<div style="background: rgba(155, 89, 182, 0.1); padding: 20px; border-radius: 10px;">
  <p align="center">
    ...
    - 🌍 **Frontend Dev** turning ideas into pixel-perfect interfaces<br>
    - 🎯 **Currently working with:** React & Next.js<br>
    - 💬 **Languages I use:** Python · Java · TypeScript · JavaScript<br>
    - 🔎 **Exploring:** Next-gen frontend tools, design systems, and smooth user journeys<br>
